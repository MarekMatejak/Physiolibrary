...
package Obsolete "Where another library works better."
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
      ...
      model MichaelisMenten "Basic enzyme kinetics"
        ...
        Physiolibrary.Obsolete.Chemical.Sources.UnlimitedSolutionStorage P(Conc=0)
          annotation (Placement(transformation(extent={{92,-12},{72,8}})));
        Physiolibrary.Obsolete.Chemical.Sources.UnlimitedSolutionStorage S(Conc=0.1)
          ...
          "Michaelis constant = substrate concentration at rate of half Vmax";
            ...
            Physiolibrary.Obsolete.Chemical.Components.Substance ES(
            solute_start=0, Simulation=Types.SimulationType.SteadyState)
          annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
            Physiolibrary.Obsolete.Chemical.Components.Substance E(
          solute_start=tE,
          isDependent=true,
          Simulation=Types.SimulationType.SteadyState)
...
<h4>a = gamma * x</h4>
      ...
      model ChemicalReaction "Chemical Reaction"
        ...
        extends Physiolibrary.Obsolete.Chemical.Interfaces.ConditionalVolume;
        ...
        Physiolibrary.Obsolete.Chemical.Interfaces.ChemicalPort_b products[nP]
          "Products"
          annotation (Placement(transformation(extent={{90,-10},{110,10}})));

        Physiolibrary.Obsolete.Chemical.Interfaces.ChemicalPort_a substrates[nS]
          "Substrates"
       ...
       extends Physiolibrary.Obsolete.Chemical.Interfaces.ConditionalHeatPort;
...
<p>Marek Matejak, Charles University, Prague, Czech Republic </p>
      ...
      extends Modelica.Icons.Example;
        ...
        Physiolibrary.Obsolete.Osmotic.Components.OsmoticCell CSF_osmotic(
        ...
        Physiolibrary.Obsolete.Osmotic.Components.Membrane choroid_plexus(
        ...
        Physiolibrary.Hydraulic.Components.Pump choroid_plexus_hydraulic(
            useSolutionFlowInput=true) annotation (Placement(transformation(
              ...
              rotation=180,
              origin={8,-22})));
        Physiolibrary.Obsolete.Osmotic.Sensors.FlowMeasure flowMeasure
          annotation (Placement(transformation(
              extent={{-10,10},{10,-10}},
              rotation=180,
              origin={8,4})));
        ...
        Physiolibrary.Obsolete.Osmotic.Sources.UnlimitedSolution ECF_osmotic(Osm=285)
        ...
        Physiolibrary.Hydraulic.Sources.UnlimitedVolume veins(P=0) annotation (
            Placement(transformation(
              ...
              rotation=180,
              origin={82,86})));
        Physiolibrary.Obsolete.Osmotic.Components.Membrane arachnoid_villi(
            useHydraulicPressureInputs=true, cond(displayUnit="ml/(mmHg.day)")
        ...
        Physiolibrary.Obsolete.Osmotic.Sensors.FlowMeasure flowMeasure1
