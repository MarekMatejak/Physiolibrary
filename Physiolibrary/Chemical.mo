...
on the model behaviour.
  ...
  package Substances "Definitions of substances"
    ...
    constant Interfaces.SubstanceDefinition Angionensinogen=Interfaces.SubstanceDefinition(
        ...
        mw=56.8,
        storeUnit="mg/dl") "AGT";
    constant Interfaces.SubstanceDefinition AngiotensinI=Interfaces.SubstanceDefinition(
        shortName="AI",
        mw=1.2965,
        storeUnit="pmol/l") "AI";
    constant Interfaces.SubstanceDefinition AngiotensinII=Interfaces.SubstanceDefinition(
        shortName="AII",
        mw=1.046,
