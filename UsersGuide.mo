...
<p>All files in this directory (Physiolibrary) and in all subdirectories, especially all files that build package &QUOT;Physiolibrary&QUOT; are licensed by the <u><b>Marek Matejak</b></u> under the <u><b>Modelica License 2</b></u>. </p>
<p><h4>Licensor:</h4></p>
...
<p>Copyright &copy; 2008-2013, Charles University in Prague, First Faculty of Medicine, Institute of Pathological Physiology</p>
...
<p>To distribute or communicate to the public copies of the <u>Original Work</u> or a <u>Derivative Work</u> under <u>this License</u>. No fee, neither as a copyright-license fee, nor as a selling fee for the copy as such may be charged under this License. Furthermore, a verbatim copy of this License must be included in any copy of the Original Work or a Derivative Work under this License.</p><p>For the matter of clarity, it is permitted A) to distribute or communicate such copies as part of a (possible commercial) collection where other parts are provided under different licenses and a license fee is charged for the other parts only and B) to charge for mere printing and shipping costs. </p>
<p>To distribute or communicate to the public copies of a <u>Derivative Work</u>, alternatively to Section 2c), under <u>any other license</u> of your choice, especially also under a license for commercial/proprietary software, as long as You comply with Sections 3, 4 and 8 below. </p><p>For the matter of clarity, no restrictions regarding fees, either as to a copyright-license fee or as to a selling fee for the copy as such apply. </p>
...
<td valign=\"top\"><p>Usefull blocks, that are missing in package Modelica.Blocks (MSL 3.2) and cubic interpolation curves, multiplication factors.</p></td>
</tr>
<tr>
<td valign=\"top\"><p><a href=\"modelica://Physiolibrary.Chemical.UsersGuide\">Chemical</a> </p></td>
<td valign=\"top\"><p>Library to chemical subsystems such as intravascular, interctitial or intracellular chemical substances in fluxes and interactions.</p></td>
</tr>
<tr>
...
<td valign=\"top\"><p>Library to termoregulation models.</p></td>
</tr>
<tr>
...
<td valign=\"top\"><p>Library to join domain above together.</p></td>
</tr>
<tr>
...
<tr>
<td valign=\"top\"><p><a href=\"modelica://Physiolibrary.ExtendedTypes.UsersGuide\">ExtendedTypes</a></td>
<td valign=\"top\"><p>Types extension to define switching between dynamic and equilibriums of system, read/write values from/to file. </p></td>
</tr>
</table>
</html>"));
end UsersGuide;
